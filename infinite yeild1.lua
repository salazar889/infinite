...
local rawTime = workspace.DistributedGameTime
local hours

if rawTime * 10 < 5000 then
	hours = math.floor(rawTime * 10)
else
	hours = math.floor(rawTime - 500) + 5000
end

local totalSeconds = math.floor(rawTime)
